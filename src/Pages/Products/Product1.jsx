...
export default function Product1() {
  return (
    <div className="container-fluid m-0 p-0">
      ...
      <section className="industrial-product-section">
              ...
              <div className="row align-items-center g-5">
                <div className="col-lg-6">
                  ...
                  <p className="industrial-description">
                    SHD-E hopper dryers are used for drying hygroscopic
                    plastics, such as PS, PP, and ABS etc., which can reach the
                    highest drying temperature up to 160℃. In addition, multiple
                    accessories are optional to realize different functions,
                    such as recycling hot air and filtering metal impurities in
                    the materials. With the floor stand, it makes floor mount of
              ...
              <div className="row align-items-center">
                <div className="col-lg-7">
                  ...
                  <p className="industrial-application-text">
                    SHD-E hopper dryers are used for drying hygroscopic
                    plastics, such as PS, PP, and ABS etc., which can reach the
                    highest drying temperature up to 160°C. In addition,
                    multiple accessories are optional to realize different
                    functions, such as recycling hot air and filtering metal
